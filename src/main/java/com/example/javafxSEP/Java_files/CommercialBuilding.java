...
public class CommercialBuilding extends ProjectType{
    private int maxSquareMeters;
    private String industry;

    private ArrayList<Floor> floorsAL;

    public CommercialBuilding(String projectName, String projectType) {
        super(projectName, projectType);
    }

    public CommercialBuilding(String projectName, String projectType, int maxSquareMeters, String industry) {
        super(projectName, projectType);
